...
\subsubsection{1.1 From Web5 slogans to operator-resident
...
\subsubsection{1.2 ConstellationBench as an empirical
...
\subsection{2. The Substrate Map}\label{the-substrate-map}
...
\subsection{3. Empirical motivation: what ConstellationBench actually
...
\subsubsection{3.1 Setup and evaluation
...
\subsubsection{3.2 Headline result: budget models beat frontier on
persona
...
\subsubsection{3.3 The alignment trap: generic safety vs specific
...
\subsubsection{3.4 Audience effect: the ``silent Guardian'' as
...
\subsubsection{3.5 Team size and ``reef bleaching'': when more agents
...
\subsubsection{3.6 Protocol implications: a forward reference to
...
\subsection{4. Phase-0 system execution receipt: bringing up the state
...
\subsubsection{4.1 Scope and design of Phase
...
\subsubsection{4.2 Implementation details and wire
...
\subsubsection{4.3 Failure modes and
...
\subsubsection{4.4 Why this matters for the substrate
...
\subsection{5. Safety, side-channels, and the Web4 security
...
\subsubsection{5.1 Numeric telemetry as a
...
\subsubsection{5.2 Behavioral commitments and layered
...
\subsubsection{5.3 HiddenLayer and the Web4 security
...
\subsubsection{5.4 Provenance as substrate governance: the Web4
...
\subsection{6. Tier ladder: coupling identity assurance and compute
...
\subsubsection{6.1 Constellation Credits as the compute
...
\subsubsection{6.2 Skeet identity tiers as the identity
...
\subsubsection{6.3 Bundling identity and compute into a single
...
\subsection{7. Discussion: PACT, non-separability, and protocol-level
...
\subsubsection{7.1 PACT as a typed operator on session
...
\subsubsection{7.2 Non-separability and the bivector
...
\subsubsection{7.3 PACT, invariants, and system-level
...
\subsection{8. Open artifacts and
...
\subsubsection{8.1 Open artifacts}\label{open-artifacts}
...
\subsubsection{8.2 Benchmark replication
...
\subsubsection{8.3 Derivation map: this paper as one slice of a master
